...
public class AnotherPawnHashTest {
    ...
    public AnotherPawnHashTest(Object edp, Object name) {
    ...
    public void test() {
        ...
        if (BitOperations.populationCount(board.pieces[WHITE][PAWN] | board.pieces[BLACK][PAWN]) > 0) {
