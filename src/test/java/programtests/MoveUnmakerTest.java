...
//import chessprogram.god.MoveOrganiser;
//import chessprogram.god.StackMoveData;
...
//            
//            Chessboard b = bs[i];
//            Chessboard copy = dCopier.copyBoard(b, b.isWhiteTurn(), false);
//            
//            
//            if (cCheckChecker.boardInCheck(b, !b.isWhiteTurn())){
//                continue;
//            }
//            
//            
...
//                MoveOrganiser.flipTurn(b);
//
//                List<Move> movesss = b.generateLegalMoves();
...
//        Chessboard copy1 = dCopier.copyBoard(board, board.isWhiteTurn(), false);
