...
import chessprogram.check.CheckMoveOrganiser;
import chessprogram.check.KingLegalMoves;
...
//                System.out.println("Stalemate");
    ...
    private static List<Move> notInCheckMoves(Chessboard board, boolean whiteTurn){
        ...
        long PENULTIMATE_RANK = whiteTurn ? BitBoardUtils.RANK_SEVEN : BitBoardUtils.RANK_TWO;
