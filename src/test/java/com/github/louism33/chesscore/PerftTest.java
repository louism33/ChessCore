...
//        System.out.println("regular board depth " + 8 + " correct.");
    ...
    @Test
    void CastlingCRAndDoublePinsTest() {
        Assert.assertEquals(
